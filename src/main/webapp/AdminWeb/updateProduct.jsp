...
<section class="home-section">
    <div class="home-content">
        <div style="height: 90%" class="manager-product">
            ...
            <form id="myForm" action="UpdateProductAdmin" method="post" enctype="multipart/form-data" class="row">
                <%
                    ...
                    int idVendor = (int) request.getAttribute("idVendor");
                    String describe = (String) request.getAttribute("describe");

                    String nameType = Product.getNameType(id_type);
                    String nameVendor = ProductDao.getNameVendor(idVendor);
...
<%--                </div>--%>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input name="image2" type="text" value="<%= imageURL %>" style="display: none">
                    <br>
                    <img id="imagePreview" src="<%= imageURL %>" alt="Hình ảnh đã chọn" style="max-width: 100px; margin-top: 10px;">
                                    </div>
...
<%--                </div>--%>
                ...
                <a style="margin-top: 130px" class="btn btn-cancel" href="ProductAdmin">Hủy bỏ</a>
                </div>
            </form>
