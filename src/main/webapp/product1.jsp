...
<%--                            <div class="checkbox-group">--%>
<%--                                <label>--%>
<%--                                    <input type="checkbox" name="supplier" value="supplier1">--%>
<%--                                    Dưới 100,000 <sup>đ</sup>--%>
<%--                                </label>--%>
<%--                                <label>--%>
<%--                                    <input type="checkbox" name="supplier" value="supplier2">--%>
<%--                                    100,000 <sup>đ</sup> - 1,000,000 <sup>đ</sup>--%>
<%--                                </label>--%>
<%--                                <label>--%>
<%--                                    <input type="checkbox" name="supplier" value="supplier3">--%>
<%--                                    Trên 1,000,000 <sup>đ</sup>--%>
<%--                                </label>--%>
                        ...
                        <div class="latest-product__text">
                            ...
                            <div class="latest-product__slider owl-carousel">
                                <div class="latest-prdouct__slider__item">
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="https://cdn1.concung.com/2022/03/56291-85271-large_mobile/sua-growplus-do-1-5kg-tu-1-tuoi.png"
                                                 alt="">
                                        </div>
                                    ...
                                    <a href="#" class="latest-product__item">
                                        ...
                                        <div class="latest-product__item__text">
                                            <h6>Bỉm tã quần Moony bé trai size XL 38 miếng (12-22kg) (giao bao bì ngẫu
                                                nhiên)</h6>
                                    ...
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="https://cdn1.concung.com/combo/2023/07/600x600-748-2023-03-59031-trans.png"
                                                 alt="">
                                        </div>
                                        <div class="latest-product__item__text">
                                ...
                                <div class="latest-prdouct__slider__item">
                                    ...
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="https://cdn1.concung.com/2020/09/42532-65686-large_mobile/sua-tam-goi-toan-than-johnson-baby-500ml.png"
                                                 alt="">
                                        </div>
                                        <div class="latest-product__item__text">
                                    ...
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="https://cdn1.concung.com/2023/10/52365-1696583967-trans.png"
                                                 alt="">
                                        </div>
                                        <div class="latest-product__item__text">
                                    ...
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="https://cdn1.concung.com/2021/10/26391-75896-large_mobile/dung-dich-giat-quan-ao-aga-ae-chai-3l.png"
                                                 alt="">
                                        </div>
                                        <div class="latest-product__item__text">
                                            <h6>Nước giặt Hàn quốc AGA - AE kháng khuẩn & bảo vệ da bé - Moonlight
                                                3L</h6>
...
<script>
    function filterProducts() {
        ...
        let selectedVendors = [];
        const checkboxes = document.querySelectorAll('input[name="vendorIds"]');

        // Duyệt qua các checkbox và thêm vào mảng nếu đã được chọn
        ...
        // Nếu không có checkbox nào được chọn, lấy tất cả vendorId
        if (selectedVendors.length === 0) {
            selectedVendors = Array.from(checkboxes).map(checkbox => checkbox.value);
        }

        console.log(selectedVendors.join(',')); // In ra để kiểm tra giá trị

        // Gửi danh sách vendorId qua AJAX
        console.log('len',selectedVendors.length)
        $.ajax({
            url: '/FilterAdvance',
            method: 'POST',
            data: {
